...
if __name__ == "__main__":
    ...
    for canal in canais_desejados:
        ...
        if canal in canais:
            ...
            df_res, df_det = pipeline_mfdfa_cenarios(sinal_real, cenarios_para_testar, diretorio_saida="meu_experimento_mfdfa", nome_canal=canal, nome_arquivo="N6")
    ...
    df_resumo_final.to_csv(
        "meu_experimento_mfdfa/resultado_geral_cenarios_NORB00006_8_13.csv",
        sep=";",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    df_detalhes_final.to_csv(
        "meu_experimento_mfdfa/resultado_detalhado_por_q_NORB00006_8_13.csv",
        sep=";",
        index=False,
        encoding="utf-8-sig"
    )