...
def pipeline_mfdfa_cenarios(sinal, lista_cenarios, diretorio_saida="resultados_mfdfa", nome_canal="canal", nome_arquivo="arquivo"):
    ...
    for cenario in lista_cenarios:
        ...
        sinal_real = bandpass_filter_fir(sinal, sfreq=200, lowcut=0.5, highcut=40.0)
        ...
        if nome == "cenario73_min128_mx4_res30_q5_ord1":
...
if __name__ == "__main__":
    ...
    caminho_edf = "test/meus_edf/sub-NORB00006_ses-1_task-EEG_eeg.edf"
    ...
    canais_desejados = ["O2", "Fp2"]  # Lista de canais desejados para processamento
    ...
    for canal in canais_desejados:
        ...
        if canal in canais:
            ...
            df_res, df_det = pipeline_mfdfa_cenarios(sinal_real, cenarios_para_testar, diretorio_saida="meu_experimento_mfdfa_0.5_40.0", nome_canal=canal, nome_arquivo="N6")
    ...
    df_resumo_final.to_csv(
        "meu_experimento_mfdfa_0.5_40.0/resultado_geral_cenarios_NORB00006_0.5_40.0.csv",
        sep=";",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    df_detalhes_final.to_csv(
        "meu_experimento_mfdfa_0.5_40.0/resultado_detalhado_por_q_NORB00006_0.5_40.0.csv",
        sep=";",
        index=False,
        encoding="utf-8-sig"
    )